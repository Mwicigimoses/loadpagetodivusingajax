                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" action="Home/save_keephopealive" id="demo-form" data-parsley-validate >
                      ...
                      <input type="text" id="fullname" class="form-control" name="author" data-parsley-trigger="change" required />
                      <br/>
                      <label for="email">Keep Hope Alive Date * :</label>
                      <input type="text" id="fullname" class="form-control" name="date" data-parsley-trigger="change" required />
                       
                      <br/>   
                      <label for="fullname">Keep Hope Alive Location * :</label>
                      <input type="text" id="fullname" class="form-control" name="image_location" required />
                       <br/>  
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody style="font-size: 11px">
                          <tr class="even pointer">
                            ...
                            <td class=" "><?php echo $row->image_location;?></td>
                            <td class="a-right a-right "><?php echo word_limiter($row->content, 5);?></td>
